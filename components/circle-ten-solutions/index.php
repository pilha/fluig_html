<?php
$url_base = "../components/circle-ten-solutions";
?>
...
<div class="container container_circle_solucitions">
    <div class="row clearfix">
        <div class="col-md-12">
            <h2 class="text-center"><b>FLUIG É COMPLETO.</b> 10 soluções, uma plataforma.</h2>
        </div>
    </div>
    <div class="col-md-12 no-padding clearfix box_circle_solucitions">
        ...
        <div class="box_desc_solution">  
            <h4>Mantenha vivo o conhecimento do seu negócio.</h4>
            <div class="col-md-7 no-pd-l">
                <p>Documente não só os arquivos como também os seus
                    processos. Tenha maior controle sobre as informações
                    e as atividades da empresa.</p>
                <a class="btn btn-green" href="#">SAIBA MAIS</a>
            </div>
            <div class="col-md-5 img-solution box_img_center">
                <img src="<?php echo $url_base ?>/images/img-solution.png" alt=""/>
            </div>
        </div>
        <ol class="solution-indicators">
            <li data-target="#circle-solutions" data-solution-to="1" class="indicator-ecm active"></li>
            <li data-target="#circle-solutions" data-solution-to="2" class="indicator-bpm"></li>
            <li data-target="#circle-solutions" data-solution-to="3" class="indicator-identity"></li>
            <li data-target="#circle-solutions" data-solution-to="4" class="indicator-esb"></li>
            <li data-target="#circle-solutions" data-solution-to="5" class="indicator-lms"></li>
            <li data-target="#circle-solutions" data-solution-to="6" class="indicator-mobile"></li>
            <li data-target="#circle-solutions" data-solution-to="7" class="indicator-wcm"></li>
